...
class LiveScoreService {
    ...
    static async liveScoreFeed(req, res) {
        ...
        try {
            const liveScoreByLeagueId = await LiveScoreRepository.liveScoreByLeagueId(league_id);
            if (liveScoreByLeagueId) {
                messageBroker.publish({
                    id: "livescore_data",
                    data: {
                        message: liveScoreByLeagueId,
                    }
                });
                return ResponseHandler.sendResponseWithData(res, StatusCodes.OK, "Livescores", liveScoreByLeagueId);
            } else {
                messageBroker.publish({
                    id: "livescore_error",
                    data: {
